...
class PrestoeCfg(LeggedRobotCfg):
    """
    ...
    class env(LeggedRobotCfg.env):
        ...
        frame_stack = 15
        c_frame_stack = 3
        num_single_obs = 53 # 47 + 6
        num_observations = int(frame_stack * num_single_obs)
        single_num_privileged_obs = 81 #73 + 8
    ...
    class asset(LeggedRobotCfg.asset):
        file = '{LEGGED_GYM_ROOT_DIR}/resources/robots/prestoe/urdf/prestoe_less.urdf'
        # file = '{LEGGED_GYM_ROOT_DIR}/resources/robots/prestoe/urdf/prestoe.urdf'
    ...
    class control(LeggedRobotCfg.control):
        ...
        stiffness = {'hipyaw': 50, 'hiproll': 50,'hippitch': 70,
                     'knee': 70, 'anklepitch': 20, 'ankleroll': 20, 'toepitch': 5}
        damping = {'hipyaw': 5.0, 'hiproll': 5.0,'hippitch': 7.0, 
                   'knee': 7.0, 'anklepitch': 2, 'ankleroll': 2, 'toepitch': 0.5}
    ...
    class rewards:
        base_height_target = 0.827   #0.827, 1.3 bend the legs without bending the torso
        min_dist = 0.15
        max_dist = 0.8
...
class PrestoeCfgPPO(LeggedRobotCfgPPO):
    seed = 5
    ...
    class algorithm(LeggedRobotCfgPPO.algorithm):
        ...
        obs_permutation = [-0.0001, -1, 2, -3, -4,\
                           ...
                           -40, -41, 42, 43, 44, -45, 46,  -33, -34, 35, 36, 37, -38, 39,\
                           -47, 48, -49, -50, 51, -52]
    ...
    class runner:
        ...
        max_iterations = 10000     #300000  # number of policy updates

        # logging
        save_interval = 20  # check for potential saves every this many iterations
        experiment_name = 'pretoe_ppo'
        run_name = ''
        # load and resume
        resume = False
